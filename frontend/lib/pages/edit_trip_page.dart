...
class _EditTripPageState extends State<EditTripPage> {
  ...
  late final TextEditingController accommodationController;
  ...
  void initState() {
    ...
    selectedAccommodationLat = widget.trip.accommodationLat;
    selectedAccommodationLng = widget.trip.accommodationLng;

    if (widget.trip.travelPace != null && widget.trip.travelPace!.isNotEmpty) {
      travelPace = widget.trip.travelPace!;
    }

    selectedPreferences.addAll(widget.trip.preferences);
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        // subtitlu
                        Text(
                          'Refine your trip details while keeping everything beautifully organized.',
                                  ...
                                  builder: (_) => TripSchedulePage(
                                    ...
                                    accommodationAddress:
                                        accommodationController.text
                                            .trim()
                                            .isEmpty
                                        ? widget.trip.accommodationAddress
